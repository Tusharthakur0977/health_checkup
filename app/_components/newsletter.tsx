          ...
          >
            ...
            <div className="relative flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="text-center lg:text-left lg:max-w-xl">
                <h3 className="text-3xl text-white mb-2">To Book Your Test</h3>
                ...
                <form className="w-full lg:w-auto">
                  <div className="flex flex-col gap-3 justify-center max-w-xs mx-auto sm:max-w-md lg:mx-0">
                    <input
                      type="name"
                    ...
                    />
                    <a
                      className="btn p-3 text-center font-bold text-white bg-blue-600 hover:bg-blue-700 shadow"
                      href="#0"
                    >
                      Request a Call back
                    </a>
